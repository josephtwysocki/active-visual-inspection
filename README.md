...
**System Flow**  
The proposed system pairs 3 static cameras with a drone. The static cameras run standard CV models and monitor for smoke events. When a potential smoke event is detected, an autonomous drone is dispatched to gather more information and ultimately decide on a course of action.  
